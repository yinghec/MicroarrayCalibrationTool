...
?>  
    <HEAD>
        <TITLE>Calibrated Microarrays</TITLE>
        <LINK REL="STYLESHEET" TYPE="text/css" HREF="background01.css">
    </HEAD>
    <BODY>
        <div class = "functions">  
            <h1><a href="./" style="text-decoration:none;">Gene-meter</h1>
            <p id="f2"><a href="./" style="text-decoration:none;">Home</a></p>
            <p id="f3"><a href="savedProject.php" style="text-decoration:none;">Open Saved Projects</a></p>
            <p id="f4"><a href="howitworks.php" style="text-decoration:none;">How It Works</a></p>
            <p id="f5"><a href="save.php" style="text-decoration:none;color:red;">Save Project</a></p>
        </div>
        <div class="mainPic">
            <img src="homepage.jpg" alt="CalibrateIt" style="width:600px;height:270px">
            <br>
        </div>
         <img src="banner1.jpg" alt="CalibrateIt" style="width:780px;height:27px" class="banner1">
        <p></p>
    ...
    <?php
        ...
        #unlink($linkpath);
        $db = new PDO('mysql:host=ovid01.u.washington.edu;port=3302;dbname=CalibratedMicroarrays', 'root', 'kikos2014');
        //$mysqli = new mysqli('mysql:host=ovid01.u.washington.edu;port=3302', 'root', 'kikos2014', 'CalibratedMicroarrays');
